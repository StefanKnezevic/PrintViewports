...
Програм даје могућност штампања више листова који су поређани један поред другог у .pdfНа овом gitHub линку се налази пример и код (PrintAll.lsp) фајл који је потребно учитати у AutoCAD. 
...
Најновији update даје могућност и штампања листова који нису један поред, али морају бити на истој удаљености.
